...
public class PageListViewActivity extends AppCompatActivity {
    ...
    private EndlessRecyclerOnScrollListener endlessRecyclerOnScrollListener = new EndlessRecyclerOnScrollListener(){
        ...
        public void onLoadNextPage(View view) {
            ...
            if (mCurrentCounter < TOTAL_COUNTER) {
                // loading more
                RecyclerViewStateUtils.setFooterViewState(PageListViewActivity.this, recyclerView, REQUEST_COUNT, LoadingFooter.State.Loading, null);
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        for (int i = 0; i < 20; i++) {
                ...
                //the end
                RecyclerViewStateUtils.setFooterViewState(PageListViewActivity.this, recyclerView, REQUEST_COUNT, LoadingFooter.State.TheEnd, null);
            }
        }
    };
}
