...
import com.example.wudz.adapter.StaListAdapter;
import com.example.wudz.recycleview.EndlessRecyclerOnScrollListener;
import com.example.wudz.recycleview.ExStaggeredGridLayoutManager;
...
public class StaListViewActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        StaListAdapter adapter = new StaListAdapter(this,list);
    ...
    private EndlessRecyclerOnScrollListener endlessRecyclerOnScrollListener = new EndlessRecyclerOnScrollListener(){
        ...
        public void onLoadNextPage(View view) {
            ...
            if (mCurrentCounter < TOTAL_COUNTER) {
                // loading more
                RecyclerViewStateUtils.setFooterViewState(StaListViewActivity.this, recyclerView, REQUEST_COUNT, LoadingFooter.State.Loading, null);
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        for (int i = 0; i < 20; i++) {
                        ...
                        headerAndFooterRecyclerViewAdapter.notifyItemRangeInserted(lastIndex, list.size());
                        headerAndFooterRecyclerViewAdapter.notifyDataSetChanged();
                        mCurrentCounter = list.size();
                ...
                //the end
                RecyclerViewStateUtils.setFooterViewState(StaListViewActivity.this, recyclerView, REQUEST_COUNT, LoadingFooter.State.TheEnd, null);
            }
        }
    };
}
